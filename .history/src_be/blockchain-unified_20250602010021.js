...
try {
  const deploymentInfo = require('../deployment-unified-info.json');
  contractAddress = deploymentInfo.artValidation;
  const ArtValidation = require('../artifacts/contracts/ArtValidation.sol/ArtValidation.json');
  contract = new ethers.Contract(contractAddress, ArtValidation.abi, wallet);
  ...
  console.warn('Unified ArtValidation contract not deployed yet. Please run deployment first.');
