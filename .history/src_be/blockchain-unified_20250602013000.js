...
function getContractInfo() {
  return {
    address: ART_VALIDATION_ADDRESS,
    validatorTokenAddress: VALIDATOR_TOKEN_ADDRESS,
    isReady: isContractReady(),
    type: 'unified',
    network: 'sepolia',
    features: ['IPFS support', 'Legacy compatibility', 'Enhanced metadata', 'Decentralized validation']
  };
}
